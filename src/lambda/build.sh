...
cd $path1
zip -ur $current_path/lambda_function.zip matplotlib/ mpl_toolkits/ kiwisolver.cpython-36m-x86_64-linux-gnu.so
...
aws s3api put-object --bucket n-body --key lambda_function.zip --body lambda_function.zip
